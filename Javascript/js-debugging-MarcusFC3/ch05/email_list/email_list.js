...
document.addEventListener("DOMContentLoaded", () => {
    ...
    $("#join_list").addEventListener("click", () => { //Fixed capitalization. was "#join_List"
        ...
        if (errorMessage == "") { //changed to double equals. was a single equals aka assignemnt operator
            $("#email_form").submit();
        } else {
            alert(errorMessage);            
        }
